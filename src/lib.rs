...
impl ServerSeekerClient {
    ...
    pub async fn whereis(&self, builder: &WhereisBuilder) -> Result<Vec<WhereisServer>, failure::Error>
    {
    ...
    pub async fn servers(&self, builder: &ServersBuilder) -> Result<Vec<ServersServer>, failure::Error>
    {
